      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="{{ asset('backend/index.html" class="text-nowrap logo-img')}}">
            <img src="{{ asset('backend/assets/images/logos/logo.svg')}}" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <!-- ---------------------------------- -->
            {{-- ================= USUARIOS ================= --}}
            <li class="sidebar-item {{ request()->is('usuarios*') ? 'selected' : '' }}">
